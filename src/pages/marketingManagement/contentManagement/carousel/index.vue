<template>
  ...
  >
    ...
    <carousel-drawer ref="carouselRef" />
  </div>
</template>
...
import carouselDrawer from './carouselDrawer.vue'
...
const carouselRef = ref<InstanceType<typeof carouselDrawer>>()
const handleCreate = () => {
  carouselRef.value!.openDrawer()
}
